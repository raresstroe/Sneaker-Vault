        ...
        <section className={className}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">
                    Actualizați informațiile despre profil și adresa de email.
                </p>
            </header>
                ...
                {mustVerifyEmail && user.email_verified_at === null && (
                    <div>
                        <p className="text-sm mt-2 text-gray-800">
                            Adresa dvs. de email nu este verificată.
                            <Link
                            ...
                            >
                                Apăsați aici pentru a trimite un nou link de
                                verificare.
                            </Link>
                        </p>
                        ...
                        {status === "verification-link-sent" && (
                            <div className="mt-2 font-medium text-sm text-green-600">
                                Un nou link de verificare a fost trimis la
                                adresa dvs. de email.
                            </div>
                        )}
                    </div>
